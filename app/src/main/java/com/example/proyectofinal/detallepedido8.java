...
public class detallepedido8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detalledelpedido8);
    ...
    private void guardarPedido(String usuario, String fecha) {
        ...
        try {
            ...
            datos.put("nombre_producto", "Agua de Limon");
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    ...
                    datos,
                    response -> {
                        Toast.makeText(detallepedido8.this, "Pedido guardado", Toast.LENGTH_SHORT).show();

                        Intent intent = new Intent(detallepedido8.this, letrero.class);
                        startActivity(intent);
                    },
                    error -> {
                        Toast.makeText(detallepedido8.this, "Error al guardar pedido", Toast.LENGTH_SHORT).show();
                    }
            );

            RequestQueue queue = Volley.newRequestQueue(detallepedido8.this);
            queue.add(request);

        } catch (Exception e) {
            Toast.makeText(detallepedido8.this, "Error en los datos", Toast.LENGTH_SHORT).show();
        }
    }
}