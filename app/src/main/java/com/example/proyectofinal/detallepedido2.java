...
public class detallepedido2 extends AppCompatActivity {
    ...
    private void guardarPedido(String usuario, String fecha) {
        ...
        try {
            ...
            datos.put("nombre_producto", "Pizza");
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    ...
                    datos,
                    response -> {
                        Toast.makeText(detallepedido2.this, "Pedido guardado", Toast.LENGTH_SHORT).show();

                        Intent intent = new Intent(detallepedido2.this, letrero.class);
                        startActivity(intent);
                    },
                    error -> {
                        Toast.makeText(detallepedido2.this, "Error al guardar pedido", Toast.LENGTH_SHORT).show();
                    }
            );

            RequestQueue queue = Volley.newRequestQueue(detallepedido2.this);
            queue.add(request);

        } catch (Exception e) {
            Toast.makeText(detallepedido2.this, "Error en los datos", Toast.LENGTH_SHORT).show();
        }
    }
}