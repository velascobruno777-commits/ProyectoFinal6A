...
public class detallepedido11 extends AppCompatActivity {
    ...
    private void guardarPedido(String usuario, String fecha) {
        ...
        try {
            ...
            datos.put("nombre_producto", "Cuernito de Chocolate");
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    ...
                    datos,
                    response -> {
                        Toast.makeText(detallepedido11.this, "Pedido guardado", Toast.LENGTH_SHORT).show();

                        Intent intent = new Intent(detallepedido11.this, letrero.class);
                        startActivity(intent);
                    },
                    error -> {
                        Toast.makeText(detallepedido11.this, "Error al guardar pedido", Toast.LENGTH_SHORT).show();
                    }
            );

            RequestQueue queue = Volley.newRequestQueue(detallepedido11.this);
            queue.add(request);

        } catch (Exception e) {
            Toast.makeText(detallepedido11.this, "Error en los datos", Toast.LENGTH_SHORT).show();
        }
    }
}