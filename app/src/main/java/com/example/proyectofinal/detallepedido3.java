...
public class detallepedido3 extends AppCompatActivity {
    ...
    private void guardarPedido(String usuario, String fecha) {
        ...
        try {
            ...
            datos.put("nombre_producto", "Baguette");
            ...
            JsonObjectRequest request = new JsonObjectRequest(
                    ...
                    datos,
                    response -> {
                        Toast.makeText(detallepedido3.this, "Pedido guardado", Toast.LENGTH_SHORT).show();

                        Intent intent = new Intent(detallepedido3.this, letrero.class);
                        startActivity(intent);
                    },
                    error -> {
                        Toast.makeText(detallepedido3.this, "Error al guardar pedido", Toast.LENGTH_SHORT).show();
                    }
            );

            RequestQueue queue = Volley.newRequestQueue(detallepedido3.this);
            queue.add(request);

        } catch (Exception e) {
            Toast.makeText(detallepedido3.this, "Error en los datos", Toast.LENGTH_SHORT).show();
        }
    }
}
